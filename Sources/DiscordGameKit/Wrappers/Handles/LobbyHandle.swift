...
public struct LobbyHandle: DiscordObject, Identifiable, Sendable, CustomStringConvertible {
    ...
    public var description: String {
        "LobbyHandle(id: \(id), linkedChannel: \(linkedChannel, default: "N/A"), lobbyMemberIds: \(lobbyMemberIds), lobbyMembersCount: \(lobbyMembers.count), metadata: \(metadata))"
    }
}
